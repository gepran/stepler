  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="btn-tactile mt-1 mr-3 shrink-0 text-neutral-400 transition-colors hover:text-yellow-500 focus:outline-none dark:text-neutral-500 dark:hover:text-yellow-400"
      >
        {task.completed ? (
              ...
              .map((st) => (
                <div
                  ...
                  className={`group/subtask relative flex items-start rounded p-1 transition-all hover:bg-neutral-200/50 dark:hover:bg-neutral-800/60 ${
                    ...
                    parseInt(st.id, 10) > MODULE_LOAD_TIME
                      ? "animate-jelly-fall"
                      : ""
                  }`}
                ...
                >
                  ...
                  <button
                    ...
                    className="btn-tactile mt-0.5 mr-2 shrink-0 text-neutral-400 transition-colors hover:text-yellow-500 focus:outline-none dark:text-neutral-500 dark:hover:text-yellow-400"
                  >
                    {st.completed ? (
                      <CheckCircle2
                        size={14}
          ...
          <div className="flex flex-wrap gap-1.5">
            ...
            {task.gcalLink && (
              <a
                ...
                className="btn-tactile group/btn relative flex items-center justify-center gap-1.5 rounded-full border border-neutral-200/60 bg-white/60 px-2 py-1 shadow-sm backdrop-blur-md transition-colors hover:bg-neutral-100 dark:border-neutral-700/60 dark:bg-neutral-800/60 dark:hover:bg-neutral-700/50"
                title="View in Google Calendar"
              >
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="icon-rubbery">
